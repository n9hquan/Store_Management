...
import Clients.Customer.Model.UneditableTableModel;

import java.awt.*;


public class SelfOrderView extends JDialog {
    ...
    public SelfOrderView(Frame owner) {
    ...
    // Add these methods to SelfOrderView
    public void setCustomerNameEditable(boolean editable) {
        txtCustomerName.setEditable(editable);
    }

    public void setOrderDateEditable(boolean editable) {
